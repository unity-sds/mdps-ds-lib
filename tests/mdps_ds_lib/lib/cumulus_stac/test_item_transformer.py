...
class TestItemTransformer(TestCase):
    def test_01(self):
        ...
        sample_stac_item = {'stac_version': '1.0.0',
        ...
        sample_stac_item = {'stac_version': '1.0.0',
                            ...
                            'assets':{
                                "P1570515ATMSSCIENCEAAT16032024518500.PDS": {
                                    ...
                                    'file:size': 760,
                                    'file:checksum': '9817be382b87c48ebe482b9c47d1525a',
                                    "roles": [
                                        "data"
                                    ]
                                },
  ...
  "record": {
    ...
    def test_03(self):
        existing_item = Item(
            id = 'test1',
            stac_extensions=["https://stac-extensions.github.io/file/v5.1.0/schema.json"],
            geometry={
                "type": "Polygon",
                "coordinates": [
                    [
        ...
        source = json.loads(source)
        stac_item = ItemTransformer().to_stac(source, source_stac=existing_item)
        sample_stac_item = {'stac_version': '1.0.0',
                            'stac_extensions': ["https://stac-extensions.github.io/file/v5.1.0/schema.json","https://stac-extensions.github.io/file/v2.1.0/schema.json"],
                            'type': 'Feature',
                            'id': 'P1570515ATMSSCIENCEAAT16032024518500.PDS',
                            'geometry': {
                                "type": "Polygon",
        ...
        # print(json.dumps(stac_item, indent=2))
        print(json.dumps(stac_item,sort_keys=True, indent=4))
        self.assertEqual(json.dumps(sample_stac_item, sort_keys=True), json.dumps(stac_item, sort_keys=True),
                         'wrong stac item')
        stac_validator = JsonValidator(json.loads(STAC_ITEM_SCHEMA))
        # self.assertEqual(None, stac_validator.validate(raw), f'invalid stac format: {stac_validator}')
        self.assertEqual(None, stac_validator.validate(stac_item), f'invalid stac format: {stac_validator}')
